...
function CreateEditBlog() {
    ...
    // Use the useNavigate hook to navigate after the form submission
    ...
    const handleSubmit = (e) => {
        ...
        // Prepare FormData for uploading image
                                ...
                                {!image ? (
                                    <>
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    d="M132.812 185.094V132.406H168.062L124 79.7188L79.9375 132.406H115.188V185.094H71.125V184.655C69.6445 184.743 68.2345 185.094 66.7188 185.094C49.1896 185.094 32.3784 178.155 19.9834 165.804C7.58843 153.453 0.625 136.701 0.625 119.234C0.625 85.4441 26.2694 57.9061 59.1753 54.1302C62.0604 39.1019 70.1107 25.545 81.9417 15.7914C93.7727 6.0377 108.645 0.696879 124 0.6875C139.357 0.695959 154.232 6.03607 166.066 15.7895C177.9 25.543 185.954 39.1003 188.842 54.1302C221.748 57.9061 247.357 85.4441 247.357 119.234C247.357 136.701 240.394 153.453 227.999 165.804C215.604 178.155 198.793 185.094 181.264 185.094C179.783 185.094 178.355 184.743 176.857 184.655V185.094H132.812Z"
                                                    fill="#777777"
                                                />
                                            </svg>
                                            <p>Upload Image</p>
